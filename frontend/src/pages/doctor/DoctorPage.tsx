...
const DoctorPage = () => {
    ...
    return (
        <main className='bg-customGreen w-screen min-h-screen'>
            <div className='flex h-14 items-center bg-customGreen2 justify-between relative'>
                ...
                <h3 className='absolute right-32 text-3xl font-bold text-gray-800 '><span className='border-b-4 border-black rounded-sm'>DO</span>CTOR</h3>
            </div>

            <div className='w-full h-4 bg-bar mt-1' />
