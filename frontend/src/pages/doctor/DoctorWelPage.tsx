    ...
    return (
        <main className="bg-customGreen flex flex-col w-full min-h-screen overflow-hidden relative">
            <div className="h-24 pt-2 bg-customGreen2 items-center">
                <h1 className="pt-4 text-center text-3xl font-bold"><span className="border-b-4 border-black rounded-sm">Do</span>ctor</h1>
            </div>
            <div className="pt-3">
                ...
                <div className="flex gap-2">
                    ...
                    <div>
                        <h1 className="font-semibold text-lg pt-4">Hello Dr. /doctorname/</h1>
